            ...
            <div class="col-lg-6">
                @if ($second)
                    <div class="card border-0 mb-4 box-shadow h-xl-300">
                        <div
                            style="background-image: url({{ env('PUBLIC_FTP_URL') . '/banner/' . $second->banner }}); height: 150px; background-size: cover; background-repeat: no-repeat;">
                        </div>
                        <div class="card-body px-0 pb-0 d-flex flex-column align-items-start">
                            ...
                            <div>
                                <small class="d-block">
                                    <a class="text-muted" href="#">{{ $second->name }}</a>
                                </small>
                                <small class="text-muted">
                                    {{ Carbon::parse($second->created_at)->diffForHumans(['parts' => 2]) }}
                                </small>
                            </div>
                        </div>
                    </div>
