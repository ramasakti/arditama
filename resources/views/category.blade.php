...
<body>
	@include('component.header-mundana')
		...
		<div class="row">
			<div class="col-md-8">
				...
				<div class="card border-0 mb-5 box-shadow">
					<div
						style="background-image: url(mundana/img/demo/1.jpg); height: 350px; background-size: cover; background-repeat: no-repeat;">
					</div>
				...
				<div class="mb-3 d-flex justify-content-between">
					...
					<img height="120" src="mundana/img/demo/blog8.jpg">
				</div>
				<div class="mb-3 d-flex justify-content-between">
					<div class="pr-3">
						<h2 class="mb-1 h4 font-weight-bold">
					...
					<img height="120" src="mundana/img/demo/1.jpg">
				</div>
				<div class="mb-3 d-flex justify-content-between">
					<div class="pr-3">
						<h2 class="mb-1 h4 font-weight-bold">
					...
					<img height="120" src="mundana/img/demo/5.jpg">
				</div>
			</div>
